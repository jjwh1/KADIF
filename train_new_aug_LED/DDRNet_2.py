...
class DDRNet(nn.Module):
    ...
    def __init__(self, num_classes=19, layers=[2, 2, 2, 2], planes=32, spp_planes=192, head_planes=96):  # 수정됨
        ...
        self.layer3_ = self._make_layer(BasicBlock, planes * 2, highres_planes, 3)     # 수정됨

        self.layer4_ = self._make_layer(BasicBlock, highres_planes, highres_planes, 3)   # 수정됨

        self.layer5_ = self._make_layer(Bottleneck, highres_planes, highres_planes, 2)   # 수정됨
